...
public final class FieldId {
  ...
  /**
   * Returns {@link RelationType#indexOf(Field) field index} of the field in the containing
   * relation.
   */
  ...
  public boolean equals(Object o) {
    ...
    return fieldIndex == fieldId.fieldIndex && Objects.equals(relationId, fieldId.relationId);
  }
  ...
  public String toString() {
    return toStringHelper(this).addValue(relationId).addValue(fieldIndex).toString();
  }
}
