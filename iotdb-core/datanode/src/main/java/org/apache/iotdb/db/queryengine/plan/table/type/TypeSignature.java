...
package org.apache.iotdb.db.queryengine.plan.table.type;
...
import static org.apache.iotdb.db.queryengine.plan.table.type.StandardTypes.TIME_WITH_TIME_ZONE;
import static org.apache.iotdb.db.queryengine.plan.table.type.TypeSignatureParameter.typeParameter;
...
public class TypeSignature {
  ...
  private String formatValue(boolean json) {
    ...
    // TODO: this is somewhat of a hack. We need to evolve TypeSignature to be more "structural" for
    ...
    typeName
        .append("(")
        .append(json ? parameters.get(0).jsonValue() : parameters.get(0).toString());
    for (int i = 1; i < parameters.size(); i++) {
      typeName
          .append(",")
          .append(json ? parameters.get(i).jsonValue() : parameters.get(i).toString());
    }
    typeName.append(")");
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.base.toLowerCase(Locale.ENGLISH), other.base.toLowerCase(Locale.ENGLISH))
