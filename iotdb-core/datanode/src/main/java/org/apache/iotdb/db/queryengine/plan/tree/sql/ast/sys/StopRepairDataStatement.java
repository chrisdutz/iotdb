...
package org.apache.iotdb.db.queryengine.plan.tree.sql.ast.sys;
...
public class StopRepairDataStatement extends Statement implements IConfigStatement {

  private boolean onCluster;

  public StopRepairDataStatement(StatementType repairDataType) {
